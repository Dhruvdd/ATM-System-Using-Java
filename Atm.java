...
{ 
    ...
    {
        System.out.println(" ");
        System.out.println("                                        "+java.time.LocalDate.now()+" *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* DDD Bank");
        ...
        System.out.println(" ");
        System.out.println("                                        | Congratulation "+username+" Your Account Has Been Succesfully Created in DDD Bank, "+city+" Branch at "+java.time.LocalDate.now()+" |");
        int choice1;
        System.out.println(" ");
        System.out.println("                                        +=="+java.time.LocalDate.now()+"==================================DDD Bank+");
        ...
        {
            System.out.println("Thank You "+username+" For Creating Account at DDD Bank, "+city);
            System.exit(1);
        }
        else
        {
    ...
    public static void Log_in() 
    {
        ...
        if(username.equals(confirm_username))
        {
            if(pass.equals(confirm_password))
            {
                ...
                System.out.println("                                            Welcome "+username+" to DDD Bank, "+city+" Branch ATM Machine");
                Scanner sc3 = new Scanner(System.in);
                System.out.println(" ");
                System.out.println("                                        +---------------------------------------------------+");
